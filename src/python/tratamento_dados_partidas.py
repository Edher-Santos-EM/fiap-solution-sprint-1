...
partidas_2018 = pd.read_csv("../../data/2018_partidas.csv")
partidas_2019 = pd.read_csv("../../data/2019_partidas.csv")
partidas_2020 = pd.read_csv("../../data/2020_partidas.csv")
...
result.to_csv('../../data/partidas_agregadas.csv', index=False)